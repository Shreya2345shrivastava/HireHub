...
import { getStudentAnalytics, getRecruiterAnalytics, getAiInsights } from "../controllers/analytics.controller.js";
...
router.route("/ai-insights").get(isAuthenticated, isRecruiter, getAiInsights);
